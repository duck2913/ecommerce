	...
	return (
		<div className="w-[90vw] mx-auto flex justify-between items-center p-3 pt-5 ">
			...
			<button className="shopping-cart relative">
				...
				<div className="badge w-[1.5rem] h-[1.5rem] rounded-[100%] bg-red-500 text-white flex justify-center items-center text-sm absolute top-0 right-0 transform translate-x-[1rem] translate-y-[-5px]">
					1
				</div>
			</button>
		</div>
